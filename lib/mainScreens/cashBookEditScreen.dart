...
class CashBookEditScreenState extends State<CashBookEditScreen> {
  ...
  getUser() async {
    setState(() {
      ...
      purchaseOrderNameController.text = widget.model!.cashBookInfo!.toString();
      purchaseOrderInfoController.text = widget.model!.cashBookInfo!.toString();
      totalAmountController.text = widget.model!.cashInAmount!.toString();
      itemsCountController.text = widget.model!.cashOutAmount!.toString();
      supplierNameController.text = widget.model!.cashBookID!.toString();
    });
  }
  ...
  Future<void> formValidation() async {
    if (purchaseOrderNameController.text.isNotEmpty &&
      ...
      fStorage.Reference reference = fStorage.FirebaseStorage.instance
          ...
          .child(fileName);
      if (imageXFile == null) {
        //purchaseOrderImageUrl = widget.model!!.toString();
      } else {
              ...
              InkWell(
                ...
                child: CircleAvatar(
                  ...
                  backgroundImage: imageXFile == null
                      ? NetworkImage(widget.model!.cashBookID!.toString())
                          as ImageProvider
